...

{
  ...
  stringptr = findfield_tri(stringptr);
  if (*stringptr == '\0') {
    incorners = 3;
  } else {
...
/*****************************************************************************/
/*                                                                           */
/*  findfield_tri()   Find the next field of a string.                           */
/*                                                                           */
...
#ifdef ANSI_DECLARATORS
char *findfield_tri(char *string)
#else /* not ANSI_DECLARATORS */
char *findfield_tri(string)
char *string;
#endif /* not ANSI_DECLARATORS */
